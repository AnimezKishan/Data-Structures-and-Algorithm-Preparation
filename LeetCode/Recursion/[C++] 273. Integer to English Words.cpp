...
public:
    ...
    string solve(int num) {
        ...
        if(num < 1000) // 989 = "Nine Hundred Eight Nine"
            return solve(num/100) + " Hundred" + ((num%100 != 0) ? " " + solve(num%100) : "");

        if(num < 1000000) // 999989 = "Nine Hundred Ninety Nine Thousand Nine Hundred Eighty Nine"
            return solve(num/1000) + " Thousand" + ((num%1000 != 0) ? " " + solve(num%1000) : "");
        
        if(num < 1000000000) // 999999989 = "Nine Hundred Ninety Nine Million Nine Hundred Ninety Nine Thousand Nine Hundred Eighty Nine"
